...
export class App {
  ...
  private routes(): void {
    ...
    this.routePrv.guestRoutes.routes(this.app);
    this.routePrv.roomRoutes.routes(this.app); // <-- Añade esta línea
    this.routePrv.bookingRoutes.routes(this.app);
    this.routePrv.serviceRoutes.routes(this.app);
    this.routePrv.invoiceRoutes.routes(this.app);
    this.routePrv.settingRoutes.routes(this.app);
  }
